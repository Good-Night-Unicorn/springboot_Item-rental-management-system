...
public interface DingdanpingjiaService extends IService<DingdanpingjiaEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<DingdanpingjiaEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<DingdanpingjiaEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<DingdanpingjiaEntity> wrapper);
