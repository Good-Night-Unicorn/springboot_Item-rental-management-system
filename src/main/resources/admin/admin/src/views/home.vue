<template>
	<div class="home-content">
		...
		<div class="statis-box">
			...
			<div id="statis2" class="statis2 animate__animated" v-if="isAuth('wupinxinxi','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-chujia3"></span>
				</div>
				<div class="right">
					<div class="num">{{wupinxinxiCount}}</div>
					<div class="name">物品信息总数</div>
				</div>
			</div>
			<div id="statis3" class="statis3 animate__animated" v-if="isAuth('zulindingdan','首页总数')">
				<div class="left">
			...
			<div id="statis4" class="statis4 animate__animated" v-if="isAuth('guihaixinxi','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-liulan12"></span>
				</div>
				<div class="right">
					<div class="num">{{guihaixinxiCount}}</div>
					<div class="name">归还信息总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<!-- 5 -->
		<div class="type5">
			<div id="wupinxinxiChart1" class="echarts1 animate__animated" v-if="isAuth('wupinxinxi','首页统计')"></div>
			<div id="wupinxinxiChart2" class="echarts2 animate__animated" v-if="isAuth('wupinxinxi','首页统计')"></div>
			<div id="wupinxinxiChart3" class="echarts3 animate__animated" v-if="isAuth('wupinxinxi','首页统计')"></div>
			<div id="wupinxinxiChart4" class="echarts4 animate__animated" v-if="isAuth('wupinxinxi','首页统计')"></div>
			<div id="zulindingdanChart1" class="echarts5 animate__animated" v-if="isAuth('zulindingdan','首页统计')"></div>
		</div>
	</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		if(this.isAuth('wupinxinxi','首页统计')){
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'wupinxinxiChart1',css:'animate__fadeInUp'},
				{id:'wupinxinxiChart2',css:'animate__fadeInUp'},
				{id:'wupinxinxiChart3',css:'animate__fadeInUp'},
				{id:'wupinxinxiChart4',css:'animate__fadeInUp'},
				{id:'zulindingdanChart1',css:'animate__fadeInUp'},
			]
