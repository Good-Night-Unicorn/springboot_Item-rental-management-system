	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.wupinbianhao" label="物品编号" prop="wupinbianhao" >
					<el-input v-model="ruleForm.wupinbianhao" placeholder="物品编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="物品类别" prop="wupinleibie" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="库存" prop="shuliang" >
					<el-input v-model.number="ruleForm.shuliang" placeholder="库存" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="库存" prop="shuliang" >
				...
				<el-form-item v-else class="input" label="租金" prop="zujin" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="租赁期限" prop="zulinqixian" >
					<el-input v-model="ruleForm.zulinqixian" placeholder="租赁期限" clearable  :readonly="ro.zulinqixian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="租赁期限" prop="zulinqixian" >
					<el-input v-model="ruleForm.zulinqixian" placeholder="租赁期限" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="租赁状态" prop="zulinzhuangtai" >
					<el-input v-model="ruleForm.zulinzhuangtai"
						placeholder="租赁状态" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="租赁流程" prop="zulinliucheng" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.zulinliucheng" label="租赁流程" prop="zulinliucheng" >
				<span class="text">{{ruleForm.zulinliucheng}}</span>
			</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.wupinxiangqing" label="物品详情" prop="wupinxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.wupinxiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.wupinxiangqing = this.ruleForm.wupinxiangqing.replace(reg,'../../../springboot70ps7jmq/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
