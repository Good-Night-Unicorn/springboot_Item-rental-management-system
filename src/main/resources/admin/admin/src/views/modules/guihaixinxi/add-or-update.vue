	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="物品状态" prop="wupinzhuangtai" >
					<el-input v-model="ruleForm.wupinzhuangtai" placeholder="物品状态" clearable  :readonly="ro.wupinzhuangtai"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="物品状态" prop="wupinzhuangtai" >
					<el-input v-model="ruleForm.wupinzhuangtai" placeholder="物品状态" readonly></el-input>
				</el-form-item>
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.wupinzhuangtai = '已归还'; 				}
				// 获取用户信息
				this.$http({
