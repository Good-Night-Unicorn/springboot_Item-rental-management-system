		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">总金额</div>
						<div class="text "  >{{detail.zongjine}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						...
						<el-button class="reserveBtn" 
							v-if="btnAuth('zulindingdan','归还')" 
							@click="onAcross('guihaixinxi','是','','','')" type="warning">
							归还
						</el-button>
						<el-button class="auditBtn" v-if="btnAuth('zulindingdan','审核')" @click="onSH" type="warning">回复</el-button>
